...
import { formatDigest, type DigestItem, type FetchError } from '../../src/output/markdown'
...
describe('Markdown Output Formatter', () => {
  ...
  describe('Edge cases', () => {
    it('should handle items with special markdown characters in title', () => {
      const items: DigestItem[] = [
        {
          title: 'Title with [brackets] and **bold**',
          link: 'https://example.com/1',
          sourceName: 'Source',
          summary: 'Test',
          importance: 3,
    ...
    it('should handle long summaries', () => {
      const longSummary =
        'This is a very long summary that contains many words and goes on and on about various topics...'.repeat(
          5,
        )
      const items: DigestItem[] = [
        {
    ...
    it('should handle URLs with special characters', () => {
      const items: DigestItem[] = [
        {
          title: 'Test',
          link: 'https://example.com/article?id=123&utm_source=test#section',
          sourceName: 'Source',
          summary: 'Test',
          importance: 3,
        },
